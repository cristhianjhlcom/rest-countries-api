...
import { Wrapper, BackButton, BorderCountriesLink, CountryContainer, Thumbnail, Information, Title, Content, Borders } from "pages/Country/Country.styles";
                  ...
                  <div>
                    {
                      country.borders.length > 0
                        ? country.borders.map((item, index) => (
                          <BorderCountriesLink to={`/${item}`} key={index}>
                            {item}
                          </BorderCountriesLink>
                        ))
